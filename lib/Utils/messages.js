...
const generateWAMessageContent = async (message, options) => {
    ...
    if (message.contextInfo.externalAdReply) {
        ...
        // WA Biasa butuh mediaType 1 (image) kalau ada thumbnail
        if (!ad.mediaType) ad.mediaType = 1;
        // WA Biasa butuh sourceUrl minimal string kosong, jangan null/undefined
        if (!ad.sourceUrl) ad.sourceUrl = ""; 
        // Pastikan renderLargerThumbnail ada nilainya
        if (ad.renderLargerThumbnail === undefined) ad.renderLargerThumbnail = false;
    }
    // ---------------------------
